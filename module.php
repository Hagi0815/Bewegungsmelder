        ...
        $form = [
            'elements' => [
                ...
                ['type' => 'RowLayout', 'items' => [
                    ...
                    // Spalte 1: Bewegungsmelder
                    ['type' => 'ColumnLayout', 'items' => [
                        ['type' => 'Label', 'bold' => true, 'caption' => 'Bewegungsmelder'],
                    ...
                    // Spalte 2: Einschalten
                    ['type' => 'ColumnLayout', 'items' => [
                        ['type' => 'Label', 'bold' => true, 'caption' => 'Einschalten'],
                    ...
                    // Spalte 3: Ausschalten
                    ['type' => 'ColumnLayout', 'items' => [
                        ['type' => 'Label', 'bold' => true, 'caption' => 'Ausschalten'],
